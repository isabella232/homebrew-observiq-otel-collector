...
class ObserviqOtelCollectorAT060 < Formula
  desc ""
  ...
  def caveats; <<~EOS
    ...
    ****************************************************************
    ...
    To start the collector service run:
      ...
      brew services start observiq/observiq-otel-collector/observiq-otel-collector@0.6.0

    To stop the collector service run:

      brew services stop observiq/observiq-otel-collector/observiq-otel-collector@0.6.0

    To restart the collector service run:

      brew services restart observiq/observiq-otel-collector/observiq-otel-collector@0.6.0
    ****************************************************************
    ...
    ****************************************************************
    To uninstall the collector and its dependencies run the following commands:
        ...
        brew services stop observiq/observiq-otel-collector/observiq-otel-collector@0.6.0
        brew uninstall observiq/observiq-otel-collector/observiq-otel-collector@0.6.0
        launchctl remove com.observiq.collector@0.6.0
